...
const expectedAnnotationsAsJSON = `[
  {
    ...
    "details": "Unused function 'SaveReportFile'",
    "external_id": "2faa123efwsfsdqwer144d723b5999101424efba41c6caf11e6da4c2d7622ae01",
    "line": 12,
    "path": "src/main/java/AppStarter.java",
    "severity": "MEDIUM",
    "summary": "GoUnusedExportedFunction"
  },
  {
    "annotation_type": "CODE_SMELL",
    "details": "Dependency go:golang.org/x/crypto:v0.17.0 is vulnerable, safe version v0.21.0 CVE-2023-42818 9.8 Improper Restriction of Excessive Authentication Attempts vulnerability with High severity found Results powered by Checkmarx(c)",
    "external_id": "2faa123efwsfsdqwer144d723b5999101424efba41c6caf11e6da4c2d7622ae02",
    "line": 9,
    "path": "src/main/java/AppStarter.java",
    "severity": "HIGH",
    "summary": "VulnerableLibrariesLocal"
  },
  {
    "annotation_type": "CODE_SMELL",
    "details": "This is an example note level message.",
    "external_id": "2faa123efwsfsdqwer144d723b5999101424efba41c6caf11e6da4c2d7622ae03",
    "line": 2,
    "path": "src/main/java/AppStarter.java",
    "severity": "LOW",
    "summary": "ExampleNoteLevel"
  },
  {
    "annotation_type": "CODE_SMELL",
    "details": "This result does not specify a level.",
    "external_id": "2faa123efwsfsdqwer144d723b5999101424efba41c6caf11e6da4c2d7622ae04",
    "line": 3,
    "path": "src/main/java/AppStarter.java",
    "severity": "LOW",
    "summary": "MissingLevel"
  }
]`

func TestSarifResultToBitBucketAnnotation(t *testing.T) {
	sarifReport, err := sarif2.FromString(sarifFileData)
	if err != nil {
	...
	for i, r := range sarifReport.Runs[0].Results {
		annotations[i] = buildAnnotation(r, "")
	}
